! function(n) {
    n.fn.stellarNav = function(i, e, s) {
        ...
        return this.each(function() {
            ...
            "right" == a.position && nav.addClass("right"), "left" == a.position && nav.addClass("left"), a.showArrows || nav.addClass("hide-arrows"), a.closeBtn && "right" != a.position && "left" != a.position && nav.find("ul:first").append('<li><a href="#" class="close-menu"><i class="fa fa-times"></i> Close Menu</a></li>'), a.scrollbarFix && n("body").addClass("stellarnav-noscroll-x"), n(".menu-toggle").on("click", function(i) {
                i.preventDefault()

                if("left" == a.position || "right" == a.position) { 
                    (nav.find("ul:first").stop(!0, !0).fadeToggle(a.openingSpeed), nav.toggleClass("active"), nav.hasClass("active") && nav.hasClass("mobile") && n(document).on("click", function(i) {
                ...
                n(this).next().length > 0 && n(this).parent("li").addClass("has-sub").append('<a class="dd-toggle" href="#"><i class="fa fa-angle-right"></i></a>')
            ...
            }), nav.find("li .dd-toggle-whole").on("click", function(i) {
                i.preventDefault(), n(this).parent("li").children("ul").stop(!0, !0).slideToggle(a.openingSpeed), n(this).parent("li").toggleClass("open")
            });
            var f = function() {
